...
TRAINING = "../../../../datas/LSTM/10ms_train_LSTM.csv"
TEST = "../../../../datas/LSTM/10ms_test_LSTM.csv"
...
model.add(LSTM(hidden_units1,
              activation='relu',
              input_shape=in_shp,
              return_sequences=True,
              name='GRU1'))
model.add(LSTM(hidden_units2,
...
filepath = 'E:\\GitHub\\PyCharmProjects\\TCPAnalyse\\models\\lstm_multi.wts.h5'
